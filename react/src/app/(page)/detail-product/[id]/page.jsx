...
import ProductRelated from "@/app/(page)/detail-product/[id]/product-related";
...
export default function ProductDetail({ params }) {
  ...
  const p = {
    ...
    description:
      "Cây cảnh bonsai mini kích thước nhỏ, phù hợp để đặt trên bàn làm việc hoặc kệ trang trí. Được tuyển chọn kỹ càng, chăm sóc dễ dàng, thích hợp cả cho người mới làm vườn.",
    specs: [
      ["Kích thước", "20-30cm"],
      ["Chất liệu đất", "Đất sạch + đá trân châu"],
      ["Màu sắc", "Xanh lá"],
    ],
  };
          ...
          <Card className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start md:items-center">
              <div className="md:col-span-2">
                {/* Main image */}
                <ZoomImage src={p.images[0]} alt={dataDetail.product} />
              </div>
              ...
              <table className="w-full text-sm">
                <tbody>
                  {p.specs.map(([k, v], idx) => (
                    ...
                    >
                      <td className="py-2 font-medium w-1/3">{k}</td>
