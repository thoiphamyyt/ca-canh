...
export default function AboutUs() {
  return (
    <div className="py-12 px-6 lg:px-12 bg-gray-50 dark:bg-gradient-to-b dark:from-gray-950 dark:to-gray-900 text-gray-800 dark:text-gray-200">
      <section className="max-w-6xl mx-auto mb-10">
        <div className="rounded-2xl overflow-hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-green-900/20 p-6 md:flex md:items-center md:justify-between transition-transform duration-300 ease-out hover:scale-[1.01]">
          <div className="flex items-center gap-4">
            <Avatar className="h-20 w-20">
              <div className="flex items-center justify-center bg-green-600 text-white font-bold rounded-full h-20 w-20 text-2xl">
                C
              </div>
            </Avatar>
            <div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <article className="lg:col-span-2 space-y-8">
          <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-green-900/20">
            <CardHeader>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-green-900/20 transition-transform duration-300 ease-out hover:scale-[1.01]">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-gray-900 dark:text-white text-lg font-semibold">
                  <Truck className="h-5 w-5 text-green-500 dark:text-green-400" />{" "}
                  Vận chuyển
                </CardTitle>
              </CardHeader>
          ...
          <Card className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-800 shadow-lg dark:shadow-green-900/20">
            ...
            <CardContent className="text-gray-700 dark:text-gray-300 space-y-4">
              <div className="flex items-start gap-3">
                <MapPin className="h-5 w-5 text-green-500 dark:text-green-400 mt-1" />
                <p className="text-sm">
                  Ấp Tân Thành Tây, Xã Tân Hòa, Tỉnh Vĩnh Long
                </p>
              </div>
              <div className="flex items-start gap-3">
                <Phone className="h-5 w-5 text-green-500 dark:text-green-400 mt-1" />
                <p className="text-sm">(+84) 987 654 321</p>
              </div>
              <div className="flex items-start gap-3">
                <Mail className="h-5 w-5 text-green-500 dark:text-green-400 mt-1" />
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button
                  variant="outline"
                  className="w-full border-gray-300 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
                >
                  Gửi email
                </Button>
              </div>
